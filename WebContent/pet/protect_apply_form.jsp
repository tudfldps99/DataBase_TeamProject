...
<body>
<form name = "form" method="POST" action="<c:url value='/pet/applyprotect' />">
<div align = "center">
</div>
<table border = "1">
<tr>
   <td align = "center" colspan = "2" style="background:#FFB2D9" height=50><strong> 목격 보호 신고 </strong></td>
</tr>
<tr>
<tr>
   <td colspan="2" style="text-align:center" height=30><b>모르는 사항이 있을 시 그 사항을 건너뛰고 입력해주세요</b></td>
</tr>
<tr>
...
<tr>
   <td align = "center" style="background:#FFB2D9"><strong>발견지역</strong></td>
...
<tr>
   <td align = "center" style="background:#FFB2D9"><strong>발견날짜</strong></td>
